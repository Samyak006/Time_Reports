...
export default function Dropdown({ styles, options, setFilter }: IDropdownProps) {
  const [dropdownList, setDropdownList] = useState<ITimekeeper[]>([...options]);
  ...
  const onChangeHandler = (e: React.ChangeEvent<HTMLInputElement>): void => {
    ...
    setDropdownList(options.filter((str) => str.name.includes(e.target.value)|| str.timekeeperId.includes(e.target.value)));
  };
